...
const __SSR__ = require('./utils').__SSR__;
...
// 移除 prodPlugins 中的所有 Null 值
prodPlugins = prodPlugins.map(plugin => !!plugin);
...
if (!__DEV__) {
  ...
  apps.forEach(function(app) {
    ...
    if (!!app.indexPage) {
      ...
      // 将所有注册的 HTML 页面添加到 OfflinePlugin 中
