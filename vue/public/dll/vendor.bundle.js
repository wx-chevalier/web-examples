var vendor_3c35dbde6e61bb8266dd =
...
exports.executeAndInject = exports.execute = exports.RequestBuilder = undefined;

var _RequestBuilder2 = __webpack_require__(5);
...
var _execute_inject = __webpack_require__(13);
...
var execute = exports.execute = _execute2.default;
...
var urlencode = __webpack_require__(6);
...
var RequestBuilder = function () {
  ...
  _createClass(RequestBuilder, [{
    ...
    value: function header() {
      var key = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "Accept";
      var value = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "application/json";
    ...
    value: function cache() {
      var cacheControl = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "no-cache";
...
module.exports.dom = __webpack_require__(7);
...
var _execute2 = __webpack_require__(11);
...
exports.default = _execute3.default;
...
function execute(url) {
  ...
  var acceptType = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : "json";
  var strategy = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : {};
...
async function _checkStatus(response, acceptType) {
  if (response.status >= 200 && response.status < 300 || response.status === 0) {
    ...
    // 获取响应体
    var body = acceptType === "json" ? await response.json() : await response.text();
...
function _decorate(initialpromise) {
  ...
  var promise = Promise.race([initialpromise, abortablePromise]);
   ...
   */
  promise.pipe = function (idOrWriteStream, fs) {
    return promise.then(function (resOrBlobData) {
      // 判断是否为 Node 环境
      if (!isNode) {
        document.querySelector(idOrWriteStream).src = URL.createObjectURL(resOrBlobData);
      } else {
        if (!fs) {
        ...
        // 如果为 Node 环境，则写入到磁盘中
        var dest = fs.createWriteStream(idOrWriteStream);
...
function loadAsset(src) {
  ...
  var promise = promises[src] = new Promise(function (resolve) {
    ...
    // 判断是否为脚本
    var isScript = typeof src === "string" && src.indexOf(".js") > -1;
