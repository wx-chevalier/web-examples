...
var program = commander
  ...
  .option('-t, --type [type]', '选择模板类型 [pwa/redux/mobx/full]', 'react')
  .allowUnknownOption()
  .on('--help', function () {
...
if (typeof projectName === 'undefined') {
  ...
  console.log();
  console.log('譬如:');
  console.log('  ' + chalk.cyan(program.name()) + chalk.green(' my-pwa-app'));
  console.log();
...
function createApp(name, type) {
  ...
  //安装相关依赖
  install('create-pwa-boilerplate', originalDirectory, function () {

    var crbInNMPath = root + '/node_modules/create-pwa-boilerplate/';
